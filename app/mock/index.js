...
const grades = [
    {
        studentId: 1,
        items: [
            { name: 'Física', pointsGiven: 51, pointsReceived: 39 },
            { name: 'Redação', pointsGiven: 56, pointsReceived: 45 },
            { name: 'História', pointsGiven: 55, pointsReceived: 44 },
            { name: 'Geografia', pointsGiven: 57, pointsReceived: 31 },
            { name: 'Quimica', pointsGiven: 51, pointsReceived: 35 },
            { name: 'Biologia', pointsGiven: 53, pointsReceived: 42 },
            { name: 'Matemática', pointsGiven: 52, pointsReceived: 40 },
            { name: 'Português', pointsGiven: 55, pointsReceived: 33 },
        ],
    },
    {
        studentId: 2,
        items: [
            { name: 'Física', pointsGiven: 51, pointsReceived: 29 },
            { name: 'Redação', pointsGiven: 56, pointsReceived: 35 },
            { name: 'História', pointsGiven: 55, pointsReceived: 34 },
            { name: 'Geografia', pointsGiven: 57, pointsReceived: 21 },
            { name: 'Quimica', pointsGiven: 51, pointsReceived: 25 },
            { name: 'Biologia', pointsGiven: 53, pointsReceived: 32 },
            { name: 'Matemática', pointsGiven: 52, pointsReceived: 30 },
            { name: 'Português', pointsGiven: 55, pointsReceived: 33 },
        ],
    },
    {
        studentId: 3,
        items: [
            { name: 'Física', pointsGiven: 51, pointsReceived: 48 },
            { name: 'Redação', pointsGiven: 56, pointsReceived: 56 },
            { name: 'História', pointsGiven: 55, pointsReceived: 5 },
            { name: 'Geografia', pointsGiven: 57, pointsReceived: 38 },
            { name: 'Quimica', pointsGiven: 51, pointsReceived: 45 },
            { name: 'Biologia', pointsGiven: 53, pointsReceived: 50 },
            { name: 'Matemática', pointsGiven: 52, pointsReceived: 49 },
            { name: 'Português', pointsGiven: 55, pointsReceived: 50 },
        ],
    },
];
